...
import { CATEGORIES } from "@/lib/constants"; // 👈 Importar desde constants (NO desde ./Header)
    ...
    <footer className="bg-blue-950 text-white">
      <div className="container mx-auto px-4 py-12 lg:py-16">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          {/* Secciones - Mismas que en Header */}
          <div>
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a href="https://www.instagram.com/elcolo.sin_filtro/" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-blue-600 hover:scale-110 transition-all duration-300" aria-label="Instagram">
              ...
              <a href="https://twitter.com/tu_usuario" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-blue-600 hover:scale-110 transition-all duration-300" aria-label="Twitter">
                <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24"><path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z"/></svg>
              </a>
              <a href="https://facebook.com/tu_usuario" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-blue-600 hover:scale-110 transition-all duration-300" aria-label="Facebook">
