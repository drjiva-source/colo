        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12">
          ...
          <div className="col-span-2 md:col-span-1">
            ...
            <div className="flex items-center gap-4">
              <a href="https://instagram.com/tu_usuario" target="_blank" rel="noopener noreferrer" className="p-2 bg-white/10 rounded-full hover:bg-blue-600 hover:scale-110 transition-all duration-300" aria-label="Instagram">
